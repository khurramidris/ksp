...
const required = ['styles.css', 'site.js', 'assets/hero-mehfil.webp', 'assets/lesson-pavilion.webp', 'assets/mughal-ornament.webp', 'assets/vertical-garden.webp', 'assets/lotus-medallion.webp'];
